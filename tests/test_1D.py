...
get_current_neighborhood_tuple = namedtuple("get_current_neighborhood_test",
                                            "input_list, i, neighborhood_center, result")
...
@pytest.mark.parametrize("get_current_neighborhood_test", get_current_neighborhood_tests)
